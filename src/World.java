public class World {
    ...
    public static final int VIEW_PLANE_WIDTH = 800;
    public static final int VIEW_PORT_DATASET_CENTRE_DISTANCE = 800;
    ...
    public static Vector3D eye; // before viewPortCentre along the circleCentre <> viewPortCentre axis (0, 0, -1)
...
//        viewPortCorner3.setX(viewPortCentreFloor.getX() + (VIEW_PLANE_WIDTH / 2f));
    ...
    public static void moveViewPortByRotator(Quaternion rotator) {
        ...
        viewPortCentre = rotator.rotate(World.getViewPortNormal(), DATASET_CENTRE);
        viewPortNormal = DATASET_CENTRE.sub(viewPortCentre).normalize();
...
//        System.out.println("viewPortCorner3 = " + viewPortCorner3);
    ...
    private static void updateEye() {
        Vector3D v = DATASET_CENTRE.sub(viewPortCentreFloor).flip().normalize();
    ...
    public static void setViewPortAngle(double viewPortAngle) {
        World.viewPortAngle = viewPortAngle;
    }
